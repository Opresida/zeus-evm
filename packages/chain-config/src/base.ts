...
export const BASE_MAINNET: ChainConfig = {
  ...
  //    DACKIE-V2 REMOVIDO: o router 0x195FBc...dd457 NÃO tem bytecode (endereço morto) — re-adicionar
  //    só com router verificado. RocketSwap mantido (router OK), mas SEM pool WETH/USDC (poolGroups pula
  //    o par automaticamente; serve só pros pares que ele realmente tiver).
  univ2Dexes: [
