...
contract ZeusMoonwellLiquidatorTest is Test {
    ...
    function setUp() public {
        liq = new ZeusMoonwellLiquidator(FAKE_AAVE_POOL, owner, INITIAL_MAX_TRADE_WEI);
        vm.startPrank(owner);
        liq.revive();
    ...
    function test_Constructor_RevertsOnZeroAavePool() public {
        ...
        new ZeusMoonwellLiquidator(address(0), owner, INITIAL_MAX_TRADE_WEI);
    }

    function test_Constructor_RevertsOnZeroOwner() public {
        vm.expectRevert();
        new ZeusMoonwellLiquidator(FAKE_AAVE_POOL, address(0), INITIAL_MAX_TRADE_WEI);
    }

    function test_Constructor_StartsKilled() public {
        ZeusMoonwellLiquidator fresh = new ZeusMoonwellLiquidator(FAKE_AAVE_POOL, owner, INITIAL_MAX_TRADE_WEI);
