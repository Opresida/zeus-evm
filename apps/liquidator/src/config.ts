...
export const envSchema = z.object({
   ...
   *  é feature de AVALIAÇÃO (roda em DRY_RUN) calibrada de dado real; o gate de LUCRO (EV) é quem protege o dinheiro.
   *  Setar false = kill-switch (volta pro global). Fica verde no painel já no DRY_RUN (canary). */
  SLIPPAGE_PER_DEX_ENABLED: boolEnv(true),
